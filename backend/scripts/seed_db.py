...
def seed_chargers(db: Session):
    ...
    chargers_data = [
        ...
        # --- Two-wheeler AC charging points ---
        # NOTE: "Ather Grid - <town> Grid Point" entries are REAL stations from
        # Ather's official grid_charging_stations.pdf (geocoded via Nominatim).
        # Ather has no grid points in mid-NH48 towns (Tumakuru/Sira/Chitradurga/
        # Davanagere/Haveri), so those stretches are served by Bolt.Earth AC
        # points below — the honest current reality of the corridor.
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - HPCL Hubli Super Service",
            "address": "HPCL Super Service Center, Hubli",
            "latitude": 15.335,
            "longitude": 75.128,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - Ather Space Hubli",
            "address": "PB Road, Bhairidevarakoppa, Hubli",
            "latitude": 15.396,
            "longitude": 75.078,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - Dharwad Ankita Residency",
            "address": "CB Road, Opp Old IB, Dharwad",
            "latitude": 15.384,
            "longitude": 75.110,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - Hosapete",
            "address": "174/1, Opp Kof, Hosapete",
            "latitude": 15.275,
            "longitude": 76.384,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - Sri Krishna Towers Khanapur Rd",
            "address": "No 14, Khanapur Road, Belagavi",
            "latitude": 15.881,
            "longitude": 74.480,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - Ather Space Panjim",
            "address": "Betim-Pomburpa Rd, Penha de Franca, Goa",
            "latitude": 15.530,
            "longitude": 73.827,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - Blive EV Store Margao",
            "address": "Aquem Alto, Margao, Goa",
            "latitude": 15.278,
            "longitude": 73.965,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - De Little Goa Calangute",
            "address": "Naika Wado, Calangute, Goa",
            "latitude": 15.546,
            "longitude": 73.765,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - HPCL Vijay Fuel Park Mangaluru",
            "address": "NH66, near Hotel, Mangaluru",
            "latitude": 12.930,
            "longitude": 74.822,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - Ather Space Mangaluru",
            "address": "Behind City Hospital, Mangaluru",
            "latitude": 12.880,
            "longitude": 74.841,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        {
            "network_slug": "ather-grid",
            "name": "Ather Grid - Udupi Himalaya Prestige",
            "address": "Kadiyali, Udupi",
            "latitude": 13.350,
            "longitude": 74.770,
            "connector_types": [ConnectorType.TYPE7],
            "power_kw": 6.0,
        ...
        # real range needs points roughly every 70-90km. Khanapur sits just
